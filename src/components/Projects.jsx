...
import { FiGithub, FiExternalLink, FiServer, FiCheck, FiLayers } from 'react-icons/fi';
...
const Projects = () => {
    ...
    const projects = [
        {
            ...
            img: img4,
            tags: ["Next.js 15", "Node.js", "Express.js", "MongoDB", "Tailwind CSS", "Framer Motion", "BetterAuth", "Stripe"],
            live: "https://promptify-marketplace.vercel.app/",
        ...
        },
        {
            ...
            img: img1,
            tags: ["Next.js", "Node.js", "Express.js", "MongoDB", "Tailwind CSS", "Framer Motion", "BetterAuth", "JWT"],
        ...
        },
        {
            ...
            img: img2,
            tags: ["React.js", "Zustand", "Sass", "React Router", "Tailwind CSS", "Vercel"],
            live: "https://react-eecommerce-projects.vercel.app/",
            clientCode: "https://github.com/Ashikur123del/doctorapont",
            serverCode: "https://github.com/Ashikur123del",
            featured: true,
        ...
        },
        {
            ...
            img: img3,
            tags: ["Angular", "TypeScript", "REST API (Java)", "Tailwind CSS", "Enterprise Architecture"],
            live: "https://mentorerp.com/",
            clientCode: "https://github.com/Ashikur123del/schoolmaneg",
            serverCode: null,
            featured: true,
    ...
    return (
        <section id="projects" className="py-20 sm:py-28 lg:py-32 bg-slate-950/50 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 sm:mb-16 gap-6 sm:gap-8">
                    <div className="max-w-2xl text-left">
                        ...
                        <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
                            Showcasing role-based full-stack architectures, enterprise ERP components, and high-performance frontend interfaces from my resume.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                        {filterCategories.map((tab) => (
                            <button
                                ...
                                className={`px-3.5 sm:px-4 py-1.5 sm:py-2 rounded-full text-[11px] sm:text-xs font-bold transition-all duration-300 ${filter === tab.value
                            ...
                            >
                                ...
                                <div className="relative h-48 sm:h-60 w-full overflow-hidden bg-slate-950 border-b border-slate-800/80">
                                    <img
                                        ...
                                        onError={(e) => { e.target.src = 'https://placehold.co/1200x630/0f172a/cyan?text=' + encodeURIComponent(project.title); }}
                                    />
